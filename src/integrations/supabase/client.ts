...
function createSupabaseClient() {
  const { url: SUPABASE_URL, publishableKey: SUPABASE_PUBLISHABLE_KEY, missing } =
    getSupabaseClientConfig();

  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    const message =
      `Missing Supabase environment variable(s): ${missing.join(", ")}. ` +
      "Set VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY (or their SUPABASE_* equivalents) in Vercel or your local .env file.";
