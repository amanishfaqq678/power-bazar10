...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'app_role' AND typnamespace = 'public'::regnamespace) THEN
    EXECUTE $exec$CREATE TYPE public.app_role AS ENUM ('admin','staff');$exec$;
  END IF;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'own profile' AND schemaname = 'public' AND tablename = 'profiles') THEN
    EXECUTE $exec$CREATE POLICY "own profile" ON public.profiles FOR ALL TO authenticated USING (auth.uid() = user_id) WITH CHECK (auth.uid() = user_id);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'read own roles' AND schemaname = 'public' AND tablename = 'user_roles') THEN
    EXECUTE $exec$CREATE POLICY "read own roles" ON public.user_roles FOR SELECT TO authenticated USING (auth.uid() = user_id);$exec$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'categories public read' AND schemaname = 'public' AND tablename = 'categories') THEN
    EXECUTE $exec$CREATE POLICY "categories public read" ON public.categories FOR SELECT USING (true);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'categories staff write' AND schemaname = 'public' AND tablename = 'categories') THEN
    EXECUTE $exec$CREATE POLICY "categories staff write" ON public.categories FOR ALL TO authenticated USING (public.is_staff(auth.uid())) WITH CHECK (public.is_staff(auth.uid()));$exec$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'products public read' AND schemaname = 'public' AND tablename = 'products') THEN
    EXECUTE $exec$CREATE POLICY "products public read" ON public.products FOR SELECT USING (true);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'products staff write' AND schemaname = 'public' AND tablename = 'products') THEN
    EXECUTE $exec$CREATE POLICY "products staff write" ON public.products FOR ALL TO authenticated USING (public.is_staff(auth.uid())) WITH CHECK (public.is_staff(auth.uid()));$exec$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'product_images public read' AND schemaname = 'public' AND tablename = 'product_images') THEN
    EXECUTE $exec$CREATE POLICY "product_images public read" ON public.product_images FOR SELECT USING (true);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'product_images staff write' AND schemaname = 'public' AND tablename = 'product_images') THEN
    EXECUTE $exec$CREATE POLICY "product_images staff write" ON public.product_images FOR ALL TO authenticated USING (public.is_staff(auth.uid())) WITH CHECK (public.is_staff(auth.uid()));$exec$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'inventory public read' AND schemaname = 'public' AND tablename = 'inventory') THEN
    EXECUTE $exec$CREATE POLICY "inventory public read" ON public.inventory FOR SELECT USING (true);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'inventory staff write' AND schemaname = 'public' AND tablename = 'inventory') THEN
    EXECUTE $exec$CREATE POLICY "inventory staff write" ON public.inventory FOR ALL TO authenticated USING (public.is_staff(auth.uid())) WITH CHECK (public.is_staff(auth.uid()));$exec$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'anyone can submit inquiry' AND schemaname = 'public' AND tablename = 'inquiries') THEN
    EXECUTE $exec$CREATE POLICY "anyone can submit inquiry" ON public.inquiries FOR INSERT WITH CHECK (true);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff read inquiries' AND schemaname = 'public' AND tablename = 'inquiries') THEN
    EXECUTE $exec$CREATE POLICY "staff read inquiries" ON public.inquiries FOR SELECT TO authenticated USING (public.is_staff(auth.uid()));$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff update inquiries' AND schemaname = 'public' AND tablename = 'inquiries') THEN
    EXECUTE $exec$CREATE POLICY "staff update inquiries" ON public.inquiries FOR UPDATE TO authenticated USING (public.is_staff(auth.uid())) WITH CHECK (public.is_staff(auth.uid()));$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff delete inquiries' AND schemaname = 'public' AND tablename = 'inquiries') THEN
    EXECUTE $exec$CREATE POLICY "staff delete inquiries" ON public.inquiries FOR DELETE TO authenticated USING (public.is_staff(auth.uid()));$exec$;
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'anyone can add quote items' AND schemaname = 'public' AND tablename = 'quote_items') THEN
    EXECUTE $exec$CREATE POLICY "anyone can add quote items" ON public.quote_items FOR INSERT WITH CHECK (true);$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff read quote items' AND schemaname = 'public' AND tablename = 'quote_items') THEN
    EXECUTE $exec$CREATE POLICY "staff read quote items" ON public.quote_items FOR SELECT TO authenticated USING (public.is_staff(auth.uid()));$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff manage quote items' AND schemaname = 'public' AND tablename = 'quote_items') THEN
    EXECUTE $exec$CREATE POLICY "staff manage quote items" ON public.quote_items FOR ALL TO authenticated USING (public.is_staff(auth.uid())) WITH CHECK (public.is_staff(auth.uid()));$exec$;
  END IF;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'categories_updated') THEN
    EXECUTE $exec$CREATE TRIGGER categories_updated BEFORE UPDATE ON public.categories FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'products_updated') THEN
    EXECUTE $exec$CREATE TRIGGER products_updated BEFORE UPDATE ON public.products FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'inventory_updated') THEN
    EXECUTE $exec$CREATE TRIGGER inventory_updated BEFORE UPDATE ON public.inventory FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'inquiries_updated') THEN
    EXECUTE $exec$CREATE TRIGGER inquiries_updated BEFORE UPDATE ON public.inquiries FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();$exec$;
  END IF;
  ...
  IF EXISTS (SELECT 1 FROM pg_class c JOIN pg_namespace n ON n.oid = c.relnamespace WHERE n.nspname = 'auth' AND c.relname = 'users') THEN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'on_auth_user_created') THEN
      EXECUTE $exec$CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();$exec$;
    END IF;
  END IF;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  IF fcount > 0 THEN
    EXECUTE $exec$REVOKE ALL ON FUNCTION public.has_role(uuid, public.app_role) FROM PUBLIC, anon, authenticated;$exec$;
  END IF;

  SELECT count(*) INTO fcount FROM pg_proc p JOIN pg_namespace n ON p.pronamespace = n.oid
    WHERE p.proname = 'is_staff' AND n.nspname = 'public';
  IF fcount > 0 THEN
    EXECUTE $exec$REVOKE ALL ON FUNCTION public.is_staff(uuid) FROM PUBLIC, anon, authenticated;$exec$;
  END IF;

  SELECT count(*) INTO fcount FROM pg_proc p JOIN pg_namespace n ON p.pronamespace = n.oid
    WHERE p.proname = 'handle_new_user' AND n.nspname = 'public';
  IF fcount > 0 THEN
    EXECUTE $exec$REVOKE ALL ON FUNCTION public.handle_new_user() FROM PUBLIC, anon, authenticated;$exec$;
  END IF;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff read product images' AND schemaname = 'storage' AND tablename = 'objects') THEN
    EXECUTE $exec$CREATE POLICY "staff read product images" ON storage.objects FOR SELECT TO authenticated USING (bucket_id = 'product-images' AND public.is_staff(auth.uid()));$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff upload product images' AND schemaname = 'storage' AND tablename = 'objects') THEN
    EXECUTE $exec$CREATE POLICY "staff upload product images" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'product-images' AND public.is_staff(auth.uid()));$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff update product images' AND schemaname = 'storage' AND tablename = 'objects') THEN
    EXECUTE $exec$CREATE POLICY "staff update product images" ON storage.objects FOR UPDATE TO authenticated USING (bucket_id = 'product-images' AND public.is_staff(auth.uid()));$exec$;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE policyname = 'staff delete product images' AND schemaname = 'storage' AND tablename = 'objects') THEN
    EXECUTE $exec$CREATE POLICY "staff delete product images" ON storage.objects FOR DELETE TO authenticated USING (bucket_id = 'product-images' AND public.is_staff(auth.uid()));$exec$;
  END IF;
END;
$$ LANGUAGE plpgsql;
